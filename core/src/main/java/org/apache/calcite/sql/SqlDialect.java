...
public class SqlDialect implements Serializable {
  ...
  protected static final Set<SqlOperator> BUILT_IN_OPERATORS_LIST =
      ImmutableSet.<SqlOperator>builder()
          ...
          .add(SqlStdOperatorTable.MATCH_ALL)
          .add(SqlStdOperatorTable.MATCH_ANY)
          .add(SqlStdOperatorTable.MATCH_PHRASE)
          .add(SqlStdOperatorTable.MATCH_PHRASE_PREFIX)
          .add(SqlStdOperatorTable.MATCH_REGEXP)
          ...
          .add(SqlStdOperatorTable.NOT_MATCH_ALL)
          .add(SqlStdOperatorTable.NOT_MATCH_ANY)
          .add(SqlStdOperatorTable.NOT_MATCH_REGEXP)
          .add(SqlStdOperatorTable.NOT_MATCH_PHRASE_PREFIX)
          .add(SqlStdOperatorTable.NOT_MATCH_REGEXP)
