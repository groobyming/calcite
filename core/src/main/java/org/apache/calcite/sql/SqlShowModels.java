...
public class SqlShowModels extends SqlCall {
  public static final SqlSpecialOperator OPERATOR =
      new SqlSpecialOperator("SHOW MODELS", SqlKind.SHOW_MODELS);
  private boolean showModels = false;
  private String regex = null;

  public SqlShowModels(SqlParserPos pos, boolean showModels) {
    super(pos);
    this.showModels = showModels;
  }

  public SqlShowModels(SqlParserPos pos, boolean showModels, String regex) {
    super(pos);
    this.showModels = showModels;
